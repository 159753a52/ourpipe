...
#SBATCH --output=/home/bingxing2/home/scx9kvs/orion-docker/ourgpipe/logs/gpipe_16stage_%j.out
#SBATCH --error=/home/bingxing2/home/scx9kvs/orion-docker/ourgpipe/logs/gpipe_16stage_%j.err

# ============================================================================
# GPipe 16-Stage 4节点训练脚本
# 
# 使用方法:
#   mkdir -p logs
#   sbatch submit_gpipe_4nodes_16stage.sh
#
# 架构:
...
echo "=========================================="
echo "GPipe 16-Stage 4-Node Training"
echo "=========================================="
...
srun --kill-on-bad-exit=1 \
    ...
    gpipe_runner.py --config configs/gpt_16stage.yaml
