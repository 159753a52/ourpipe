#!/bin/bash
#SBATCH --job-name=gpt_8gpu_orion
#SBATCH --nodes=2
...
#SBATCH --output=/home/bingxing2/home/scx9kvs/orion-docker/ourgpipe/logs/gpt_8gpu_orion_%j.out
#SBATCH --error=/home/bingxing2/home/scx9kvs/orion-docker/ourgpipe/logs/gpt_8gpu_orion_%j.err

# ============================================================================
# GPT 8-GPU Orion 调度器训练脚本
# 
# 使用方法:
#   mkdir -p logs
#   sbatch submit_8gpu_orion.sh
#
# 架构:
...
echo "=========================================="
echo "GPT 8-GPU Orion Scheduler Training"
echo "=========================================="
...
echo "TF32:         Enabled"
echo "Config:       configs/gpt_8gpu_orion.yaml"
...
srun --kill-on-bad-exit=1 \
    ...
    gpipe_runner.py --config configs/gpt_8gpu_orion.yaml

echo "=========================================="
echo "Training completed!"
echo "Check logs at: logs/gpt_8gpu_orion_${SLURM_JOB_ID}.out"
echo "=========================================="
